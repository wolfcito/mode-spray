import { TooltipIconProps } from './tooltip-icon.type'
import clsx from 'clsx'

export function TooltipIcon({ className, linkTo }: TooltipIconProps) {
  return (
    <a href={linkTo} className={clsx('inline-block', className)}>
